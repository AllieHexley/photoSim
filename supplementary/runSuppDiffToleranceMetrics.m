...
if resimulate =='y'
    ...
    [NZ] = getDistortions(1:5,Sim,NZ,NZ.spd,T_cies026, mb026, smallestBit,5);
    ...
    [CRT] = getLimitedPSRM(CRT,Sim);
    [LCD] = getLimitedPSRM(LCD,Sim);
    [DP] = getLimitedPSRM(DP,Sim);
    [nb5p] = getLimitedPSRM(nb5p,Sim);
    [bb5p] = getLimitedPSRM(bb5p,Sim);
    [Man] = getLimitedPSRM(Man,Sim);
    [MPHDR] = getLimitedPSRM(MPHDR,Sim);
    [NZ] = getLimitedPSRM(NZ,Sim);
