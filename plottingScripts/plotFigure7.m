...
print(fig, '..\plots\fig7ai.pdf','-dpdf');
...
fig.PaperPositionMode = 'manual';
fig.PaperPosition=[0.1 0.1 3 1];
print(fig, '..\plots\fig7aii.pdf','-dpdf');
...
print(fig, '..\plots\fig7bi.pdf','-dpdf');
...
fig.PaperPositionMode = 'manual';
fig.PaperPosition=[0.1 0.1 3 3];
print(fig, '..\plots\fig7bii.pdf','-dpdf');
...
fig.PaperPositionMode = 'manual';
fig.PaperPosition=[0.1 0.1 3 1];
print(fig, '..\plots\fig7ci.pdf','-dpdf');
...
fig.PaperPositionMode = 'manual';
fig.PaperPosition=[0.1 0.1 3 1];
print(fig, '..\plots\fig7cii.pdf','-dpdf');
